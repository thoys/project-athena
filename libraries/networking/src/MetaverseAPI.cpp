...
namespace MetaverseAPI {
    ...
    QUrl getCurrentMetaverseServerURL() {
        ...
        Setting::Handle<QUrl> selectedMetaverseURLSetting {"private/selectedMetaverseURL", NetworkingConstants::METAVERSE_SERVER_URL_STABLE};
        ...
        if (QProcessEnvironment::systemEnvironment().contains(HIFI_METAVERSE_URL_ENV)) {
            ...
            return serverURL;
        } else if (selectedMetaverseURL.isValid()) {
